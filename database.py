...
def submit():
    ...
    #showinfo messagebox
    messagebox.showinfo("Address", "Inserted Succesfully")
...
delete_boxx = Label(root, text="Delete ID")
delete_boxx.grid(row=9, column=0, pady=5)

submit_btn = Button(root, text="Add Records",command=submit)
submit_btn.grid(row=6, column=0, columnspan=2, pady=10, padx=10, ipadx=100)

query_btn = Button(root, text="Show button", command=query)
